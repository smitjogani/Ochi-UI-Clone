...
const Footer = () => {
  return (
    <div className='w-full h-screen p-16 flex gap-5'>
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className='text-[6vw] font-bold uppercase tracking-tighter leading-none -mb-2'>Eye-</h1>
          <h1 className='text-[6vw] font-bold uppercase tracking-tighter leading-none -mb-2'>Opening</h1>
        </div>
      ...
      <div className="w-1/2 h-full pb-16">
        <h1 className='text-[5vw] font-bold uppercase tracking-tighter leading-none -mb-2'>PRESENTATION</h1>
        <div className="flex flex-col justify-between dets h-full pt-8">
          <div className='pt-16'>
            <a href="#" className='block text-xl font-light'>FACEBOOK</a>
            <a href="#" className='block text-xl font-light'>INSTRAGRAM</a>
          ...
          <div className='text-[1.8vw] translate-x-[5vw]'>
